...
- **Proxy inverso y TLS.** Caddy, con el certificado emitido a mano por USAL (sin ACME, restricción fija del mapa). Quedan tres puntos sin verificar en la documentación de Caddy antes de que esta pieza esté cerrada del todo — ver ticket de investigación nuevo.
...
- **Tres puntos sobre Caddy sin verificar**, movidos a un ticket de investigación nuevo: si un certificado propio desactiva ACME por completo para ese sitio, cómo recarga sin cortar servicio al sustituir el certificado, y qué formato/orden espera para el fichero de certificado con intermedios.
